...
const Hero = () => {
  return (
    ...
    <div className={`${styles.paddingX} absolute  inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5   z-20`}>
      ...
      <button className='px-10 py-3 bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-lg shadow-lg mt-5 font-bold text-lg  hover:m-5'><a href="" >Check Resume</a></button>
      </div>
    </div>
    {/* <ComputersCanvas/> */}
